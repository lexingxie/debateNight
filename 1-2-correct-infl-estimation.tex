...
\TODO{LX}{to be self-contained, we need to add a few sentences saying what data is missing from retweet cascades. Either directly quote text from (Rizoiu2018), or significantly paraphrase.}
