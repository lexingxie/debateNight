...
%PDF Info Is Required:
 \pdfinfo{
	/Title (Estimating user influence from retweet cascades with latent structure)
	/Author (Marian-Andrei Rizoiu, Rohit Ram, Lexing Xie)
}
...
\graphicspath{{img//}{img/yifei-work//}{img/wordclouds//}{img/new-vs-old-infl//}}
...
\input{1-2-correct-infl-estimation}

\input{3-changes-from-old-influence-estimation}
%
%\input{3-tweet-influence}
%
%\input{4-measures-dataset}
%
%\input{5-evaluation-user-influence}
%
